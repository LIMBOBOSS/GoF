...
class AndroidDeveloper(IDeveloper):
    ...
    def create_display(self):
        self.__phone.append_data("Samsung dispaly crated; ")
    
    def create_box(self):
        self.__phone.append_data("Samsung box created; ")
    
    def system_install(self):
        self.__phone.append_data("Android system instaled; ")
...
class IphoneDeveloper(IDeveloper):
    ...
    def create_display(self):
        self.__phone.append_data("Iphone dispaly created; ")
    
    def create_box(self):
        self.__phone.append_data("Iphone box created; ")
    
    def system_install(self):
        self.__phone.append_data("IOS system instaled; ")
